...
const downloadFile = async (url, fallbackName) => {
  ...
  if (!res.ok) {
    ...
    console.error('❌ [DEBUG-COMPONENT-ExportPanel] Error respuesta downloadFile — status:', res.status, 'data:', data);
...
export default function ExportPanel() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      console.error('❌ [DEBUG-COMPONENT-ExportPanel] Error generando la exportación:', err);
