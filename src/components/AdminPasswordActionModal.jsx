...
// (bloquear un cliente, purgar un archivo — ver ChatArea.jsx). Un solo
// componente para las dos porque son idénticas en forma; lo único que
// cambia es el texto y qué hace onConfirm.
